...
* Làm quen với Amazon Lightsail - giải pháp VPS đơn giản hóa.
* Tìm hiểu về Containerization (Docker) và triển khai trên Lightsail.
* So sánh sự khác biệt giữa EC2 và Lightsail.
...
* Hiểu rõ khi nào nên dùng Lightsail (nhanh, trọn gói) và khi nào dùng EC2 (linh hoạt).
* Triển khai thành công một website WordPress chỉ trong vài phút với Lightsail.
* Nắm được khái niệm cơ bản về Container và Docker.
* Biết cách deploy một ứng dụng container hóa lên AWS một cách đơn giản nhất.
