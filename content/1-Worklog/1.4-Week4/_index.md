...
* Get familiar with Amazon Lightsail - the simplified VPS solution.
* Learn about Containerization (Docker) and deployment on Lightsail.
* Compare the differences between EC2 and Lightsail.
...
* Understood when to use Lightsail (fast, bundled) vs EC2 (flexible).
* Successfully deployed a WordPress website in minutes using Lightsail.
* Grasped basic concepts of Containers and Docker.
* Learned how to deploy a containerized application to AWS in the simplest way.
