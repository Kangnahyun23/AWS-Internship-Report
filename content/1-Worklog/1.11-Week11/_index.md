...
* Automate deployment process (CI/CD) for Serverless applications.
* Advanced Monitoring & Tracing.
* Introduction to GraphQL (AppSync) - modern API technology.
...
* Established automated CI/CD pipeline, reducing human error during deployment.
