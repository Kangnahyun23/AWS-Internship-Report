...
* Get acquainted with company culture, TEEJ team members, mentors, and FCJ participants.
* Initialize and set up a standard AWS account environment.
* Understand and configure Cost Management.
...
* Successfully integrated into the new environment, connected with TEEJ team, Mentors, and FCJ peers.
* Secured AWS account with MFA enabled for Root User.
* Successfully set up budget alerts to avoid "bill shock".
* Understood the Shared Responsibility Model.
* Managed Users, Groups, and Permissions with IAM.
